...
pub fn resolve_updates(
    ...
    for reference in references {
        ...
        if !sha_mismatch && current_ref_matches_requested_style(reference, target_tag, options.style) {
            continue;
        }
...
fn current_ref_matches_requested_style(reference: &Reference, target: &Tag, style: PinStyle) -> bool {
    match style {
